...
export default function DailyDashboard() {
  ...
  const divisionName = plan?.division?.name || "N/A";
  link.download = `${divisionName}-${formatDate(reportDate)}.png`;
  ...
  return (
    <div className="p-6 space-y-6 bg-gray-50 min-h-screen  mb-5">
      ...
      <div id="export-area" className="space-y-2 bg-white p-4 pb-6">
        ...
        {/* Main Summary Table */}
        <div className="grid grid-cols-1 xl:grid-cols-[260px_1fr] gap-4 overflow-hidden p-6">
          ...
          <table className="w-full text-xs border border-collapse ">
            <thead className="bg-green-100 text-gray-700">
              <tr>
                ...
                <th className="border   text-center" colSpan={8}>
                  ลางาน
                </th>
                <th className="border   text-center" rowSpan={3}>
                  รวม
              ...
              <tr>
                <th className="border   text-center">ป่วย</th>
                <th className="border   text-center">ขาด</th>
                <th className="border   text-center">พักร้อน</th>
                <th className="border   text-center">อื่นๆ</th>
                <th className="border   text-center">ป่วย</th>
                <th className="border   text-center">ขาด</th>
                <th className="border   text-center">พักร้อน</th>
                <th className="border   text-center">อื่นๆ</th>
            ...
            <tbody>
              ...
              <tr className="font-bold text-xl">
                ...
                <td className="border text-center bg-amber-200" rowSpan={2}>
                  {formatNumber(totalPlanManpower)}
                </td>

                {/* ขาด / เกิน ตาราง */}
                <td className="border text-center bg-blue-200">
                ...
                {/* รวมลางาน */}
                <td className="border text-center bg-blue-200" rowSpan={2}>
          ...
          >
            <div className="grid grid-cols-1 xl:grid-cols-[260px_1fr] gap-1 overflow-hidden p-6">
              {maxByJob[items[0]?.jobId] !== undefined && (
                <table className="w-full text-xs border border-collapse ">
                  <tr>
                    <td className="bg-amber-300 text-2xl" colSpan={3}>
                      {jobName}
                    </td>
                  </tr>
                  <tr>
              ...
              <table className="w-full text-xs border border-collapse ">
                <thead>
                  <tr className="bg-yellow-100 text-gray-700">
                    ...
                    <th className="border   text-center" colSpan={9}>
                      ลางาน
                    </th>
                    <th className="border   text-center" colSpan={4}>
                      ล่วงเวลา
                ...
                <tbody className="text-xl">
                        ...
                        {isOffShift ? (
                          <>
                            ...
                            <td
                              ...
                              colSpan={3}
                            ></td>
                            <td className="border   text-center font-bold text-blue-600">
                              {isEdit
                                ? editInput("inRoster")
                          ...
                          <>
                            ...
                            <td className="bg-amber-100 border   text-center font-bold text-gray-700">
                            ...
                            <td
                              className={`border   text-center font-bold ${
                                d.inRoster - (d.manpower + d.shiftReserve) < 0
                                  ? "text-red-500"
                                  : "text-green-600"
                              }`}
                            >
                            ...
                            {[
                              ...
                              <td
                                key={f}
                                className="border   text-center text-gray-600"
                              >
                                {isEdit
                                  ? editInput(f)
                                  : d[f] === 0
                            ...
                            <td className="bg-amber-100 border   text-center font-bold">
                              {formatNumber(totalLeave)}
                            </td>
                            ...
                            <td className="bg-amber-100 border   text-center">
                              {formatNumber(
                                (isEdit
                                  ? Number(editForm.manpowerOperate) || 0
                            ...
                            <td className="border   text-center text-gray-600">
                              {isEdit
                            ...
                            <td className="bg-amber-100 border   text-center font-bold text-blue-800">
                              {formatNumber(totalRealSend)}
                            </td>
                            <td
                              className={`bg-amber-100 border   text-center font-bold ${
                                balanceFromPlan < 0
                                  ? "text-red-500"
                                  : "text-green-600"
                              }`}
                        ...
                        <td className="border text-center ">
                          {!isEdit ? (
                            ...
                            <div className="flex flex-col gap-1 items-center">
                              <button
                                className=" p-1 bg-green-600 hover:bg-green-700 text-white rounded shadow  w-full"
                                onClick={saveEdit}
                              >
                                Save
                              </button>
                              <button
                                className="p-1 bg-gray-400 hover:bg-gray-500 text-white rounded shadow  w-full"
                                onClick={() => {
                                  setEditingKey(null);
                                  setEditForm({});
                                }}
                  ...
                  <tr className="bg-blue-100 font-bold text-gray-800">
                    <td className="border   text-center" rowSpan={2}>
                      รวม
                    </td>
                    <td className="border   text-center" rowSpan={2}>
                    ...
                    <td
                      className="border   text-center bg-blue-200"
                      rowSpan={2}
                    >
                      {formatNumber(
                        sumField(items, "manpower") +
                    ...
                    {[
                      ...
                      <td key={f} className="border   text-center" rowSpan={2}>
                    ...
                    <td
                      className="border   text-center bg-gray-200"
                      rowSpan={2}
                    ></td>
                  </tr>
                  <tr className="bg-blue-100">
                    <td> {sumNegative(items, manDiff)}</td>
                    <td> {sumNegative(items, operateDiff)}</td>
                    <td> {sumNegative(items, diffPlan)}</td>
                  </tr>
                </tbody>
              </table>
            </div>
